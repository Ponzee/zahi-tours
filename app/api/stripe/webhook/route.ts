  ...
  try {
    switch (event.type) {
      case 'checkout.session.completed': {
        ...
        // Handle subscription orders only (shop orders removed - using AllPay now)
      ...
      case 'payment_intent.succeeded': {
        // Shop orders removed - using AllPay now
        // This handler is kept for subscription payments only
        break;
      }
