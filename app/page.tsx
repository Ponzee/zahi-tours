      ...
      <main id="main-content" className="flex-1">
        ...
        <section id="about" className="py-12 md:py-16 lg:py-20 border-t border-[#e5ddd4] bg-gradient-to-b from-white via-[#faf8f5] to-white">
          <div className="max-w-[100rem] mx-auto px-4 md:px-6 lg:px-8">
            <div className="grid lg:grid-cols-[2.2fr_1fr] gap-10 lg:gap-12 items-stretch">
              ...
              <div className="mt-8 lg:mt-0 lg:pt-[4.5rem] flex justify-end items-end h-full">
                <div className="relative rounded-2xl overflow-hidden shadow-lg border border-[#e5ddd4] bg-[#f5f2ed]" style={{ height: '100%', width: 'calc(100% * 16 / 9)', maxWidth: '85%' }}>
