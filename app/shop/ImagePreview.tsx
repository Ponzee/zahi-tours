          ...
          >
            <div className="relative overflow-hidden rounded-[30px] shadow-[0_40px_90px_rgba(0,0,0,0.55)]">
              ...
              <div className="relative aspect-[3/4] w-full overflow-hidden rounded-[30px] bg-[#0b0b0b] max-h-[80vh]">
                ...
                <button
                  onClick={() => setModalOpen(false)}
                  className="absolute bottom-[101px] left-1/2 -translate-x-1/2 rounded-full bg-[#1a1612]/85 px-12 py-4 text-sm font-semibold uppercase tracking-wide text-white shadow-lg hover:bg-black"
                >
                  Close
                </button>
                {gallery.length > 1 && (
