...
export default function LayoutWrapper({
  ...
  if (isShopPage) {
    ...
    return (
      <div className="bg-[#faf8f5] px-4 md:px-6 lg:px-8 py-4">
        <div className="bg-white rounded-2xl border border-[#e5ddd4] shadow-sm overflow-hidden">
          {children}
          {footer}
        </div>
      </div>
  ...
  return (
    <div className="flex-1 min-h-0 bg-[#faf8f5] px-4 md:px-6 lg:px-8 py-4 overflow-hidden">
      <div className="flex-1 min-h-0 bg-white rounded-2xl border border-[#e5ddd4] shadow-sm overflow-hidden flex flex-col">
