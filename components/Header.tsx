      ...
      {mobileMenuOpen && (
        <div id="mobile-menu" className="md:hidden border-t border-[#e5ddd4] bg-white" role="menu">
          <nav className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-4 flex flex-col gap-3" role="navigation" aria-label="Mobile navigation">
            <Link href="/watch" className="py-2 text-sm sm:text-base text-[#1a1612] hover:text-[#c2410c] transition-colors duration-150" onClick={() => setMobileMenuOpen(false)}>Stories</Link>
            <Link href="/support" className="py-2 text-sm sm:text-base text-[#1a1612] hover:text-[#c2410c] transition-colors duration-150" onClick={() => setMobileMenuOpen(false)}>Support</Link>
            <Link href="/shop" className="py-2 text-sm sm:text-base text-[#1a1612] hover:text-[#c2410c] transition-colors duration-150" onClick={() => setMobileMenuOpen(false)}>Shop</Link>
            <Link href="/about" className="py-2 text-sm sm:text-base text-[#1a1612] hover:text-[#c2410c] transition-colors duration-150" onClick={() => setMobileMenuOpen(false)}>About</Link>
            <Link href="/contact" className="py-2 text-sm sm:text-base text-[#1a1612] hover:text-[#c2410c] transition-colors duration-150" onClick={() => setMobileMenuOpen(false)}>Contact</Link>
