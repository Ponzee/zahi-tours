...
export default function VideoCard({ video }: VideoCardProps) {
  ...
  return (
    <a
      ...
      className="group rounded-2xl border border-[#e5ddd4] bg-[#f5f2ed] shadow-sm hover:shadow-md transition-all overflow-hidden block"
    >
      ...
      <div className="p-4 md:p-5">
        <h3 className="font-bold text-base md:text-lg tracking-tight text-[#1a1612] line-clamp-2 mb-2 group-hover:text-[#c2410c] transition-colors">
          {video.title}
        </h3>
        {video.publishedAt && (
